<footer class="bg-[#1e293b] text-white py-10 px-4 border-t-4 border-yellow-500">
    ...
    <div class="grid grid-cols-2 md:grid-cols-5 gap-8">
      ...
      <div class="col-span-2 md:col-span-1">
        <a href="{{ route('home') }}" class="flex items-center mb-6">
          <img 
            ...
            alt="outlearn logo" 
            class="mr-2 h-6 w-auto filter invert"
          />
          <span class="text-xl font-semibold">outlearn</span>
        </a>
      ...
      <div>
        ...
        <ul class="space-y-2 text-gray-300">
          ...
          <li><a href="{{ route('tutorials') }}" class="hover:text-white">Tutorials</a></li>
          <li><a href="{{ route('webinars') }}" class="hover:text-white">Webinars</a></li>
      ...
      <div>
        ...
        <ul class="space-y-2 text-gray-300">
          ...
          <li><a href="{{ route('press') }}" class="hover:text-white">Press</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-2 text-gray-300">
          ...
          <li><a href="{{ route('forum') }}" class="hover:text-white">Forum</a></li>
      ...
      <div>
        ...
        <ul class="space-y-2 text-gray-300">
          ...
          <li><a href="https://instagram.com" class="hover:text-white">Instagram</a></li>
          <li><a href="https://facebook.com" class="hover:text-white">Facebook</a></li>
          <li><a href="https://linkedin.com" class="hover:text-white">LinkedIn</a></li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="mt-10 pt-6 border-t border-gray-700 text-center text-gray-400 text-sm">
    <p>© {{ date('Y') }} outlearn. All rights reserved.</p>
  </div>
</footer> 