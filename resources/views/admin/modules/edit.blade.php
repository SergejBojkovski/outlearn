        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-6">
                        <h3 class="text-lg font-semibold text-gray-800">Editing Module for Course: {{ $course->title }}</h3>
                    </div>

                    <form action="{{ route('admin.modules.update', [$course->id, $module->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <x-input id="order" class="block mt-1 w-full" type="number" name="order" :value="old('order', $module->order)" min="1" required />
