                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('admin.courses.update', $course) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="description" name="description" rows="4" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full">{{ old('description', $course->description) }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 text-xs mt-1">Leave empty to keep the current thumbnail</p>
                                @error('thumbnail')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <x-input id="duration" class="block mt-1 w-full" type="number" name="duration" :value="old('duration', $course->duration)" min="1" step="0.5" />
                                @error('duration')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="requirements" name="requirements" rows="3" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full" placeholder="Enter each requirement on a new line">{{ old('requirements', $course->requirements) }}</textarea>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="what_you_will_learn" name="what_you_will_learn" rows="3" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full" placeholder="Enter each learning point on a new line">{{ old('what_you_will_learn', $course->what_you_will_learn) }}</textarea>
